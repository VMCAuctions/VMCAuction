...
class ItemEdit extends Component{
    ...
    componentDidMount(){
        ...
        .then((response)=>{
         ...
         Axios.get("/api/items/"+this.props.match.params.itemId)
            .then((result) =>{
                    ...
                    this.setState({
                        ...
                        fairMarketValue: item.value,
                        itemDescription: item.description,
                        itemRestriction: item.restrictions,
                    })
    ...
    formSubmit = (e) =>{
        ...
        Axios({
            method: "post",
            url:("/api/items/"+this.props.match.params.itemId),
