          ...
          User.findOne({
            ...
            if (err) {
              ...
              res.render("main", {
                ...
                auctions: auctions,
                archivedAuctions: [{
                    name: "Fall '17 Gala Puttin' on the Ritz",
                    _id: "1001"
                  },
                  {
                    name: "Christmas 2017 Fundraiser",
                    _id: "1002"
                  },
                  {
                    name: "Las Vegas 2017 Donor Evening",
                    _id: "1236"
                  }
                ]
              });
                ...
                for (var x = 0; x < users.length; x++) {
                  ...
                  for (var y = 0; y < packages.length; y++) {
                    ...
                    if (packages[y].bids.length > 0) {
                      ...
                      if (packages[y].bids[packages[y].bids.length - 1].name === users[x].firstName.charAt(0) + '. ' + users[x].lastName 
                                || packages[y].bids[packages[y].bids.length - 1].name === users[x].firstName + ' ' + users[x].lastName) {
                        packagesArr.push(packages[y]);
                        // items.push.apply(items,packages[y]._items);
